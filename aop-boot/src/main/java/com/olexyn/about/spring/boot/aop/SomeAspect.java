...
public class SomeAspect {
    ...
    @Before(value = "execution(* com.olexyn.about.spring.boot.aop.SomeService.*(..)) && args(a,b)")
    public void beforeAdvice(JoinPoint joinPoint, String a, String b) {
        System.out.println("before " + a + b);
    }

    @After(value = "execution(* com.olexyn.about.spring.boot.aop.SomeService.*(..)) && args(a,b) && anyPublicOperation()")
    ...
    @Pointcut("within(com.olexyn.about.spring.boot.aop.SomeController)")
    public void anyOverridingMethod323() { }

    @Pointcut("this(com.olexyn.about.spring.boot.aop.SomeBean)")
